...
from .runtime_mirror.hot_certificate_path import try_hot_certificate_path
...
from .sitegraph_hot_query_eval import matching_hot_query_proof
...
def recall_documents_with_stats(
    ...
    *,
    ...
    hot_state = try_hot_certificate_path(
        index=index,
        query=query,
        limit=limit,
        terms=terms,
    ...
    if "results" in hot_state:
        return hot_state
    phase_timings_ms = hot_state["phase_timings_ms"]
    hot_initial_certificate = hot_state["hot_initial_certificate"]
    hot_initial_stats = hot_state["hot_initial_stats"]
    hot_initial_ranked = hot_state["hot_initial_ranked"]
