...
RARE_DYNAMIC_FIRST_TRUSTED_LOCAL_INDEX_BYTES = 128 * 1024
RARE_DYNAMIC_TOP_RESULTS_LOCAL_INDEX_BYTES = 512 * 1024
RARE_DYNAMIC_QUICK_MAX_SHARD_LOADS = 4
RARE_DYNAMIC_MIN_FIRST_TRUSTED_LOCAL_INDEXES = 1
RARE_DYNAMIC_MIN_TOP_RESULTS_LOCAL_INDEXES = 3
...
DYNAMIC_HOLDOUT_FIRST_TRUSTED_MAX_UNCACHED_BYTES = int(1.5 * ONE_MIB)
DYNAMIC_HOLDOUT_TOP_RESULTS_MAX_UNCACHED_BYTES = 3 * ONE_MIB
DYNAMIC_HOLDOUT_PROOF_MAX_UNCACHED_BYTES = 2 * ONE_MIB
DYNAMIC_HOLDOUT_PROOF_MAX_ARTIFACT_MISSES = 40
