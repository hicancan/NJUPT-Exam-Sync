...
QUERY_SYNONYMS: dict[str, list[str]] = {
    ...
    "图书馆开放时间": ["开放时间", "图书馆开放", "临时延长图书馆开放时间"],
    "VPN": ["WebVPN", "VPN客户端", "智慧校园门户使用WebVPN"],
    "校园网": ["网络服务", "校园网常见问题", "校园网费用"],
    "就业协议": ["就业协议书", "就业推荐表", "协议书打印", "协议书补办", "就业协议书打印"],
    "招聘会": ["双选会", "宣讲会", "专场招聘会", "网络招聘会"],
    "体育补测": ["体测补测", "体测", "体质测试", "体育测试补测"],
    "校园通行证": ["通行证", "电动自行车通行证", "门卫管理"],
    "服务流程": ["办事流程", "办理流程", "信息化用户服务流程"],
    "信息公开": ["信息公开报告", "信息公开指南", "信息公开受理"],
    "计算机学院": ["软件学院", "网络空间安全学院", "计软网安"],
    "通信学院": ["通信与信息工程学院", "通院"],
    "贝尔英才": ["贝尔英才学院", "英才学院"],
}
