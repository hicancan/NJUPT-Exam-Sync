...
export const FIRST_TRUSTED_MAX_UNCACHED_BYTES = 5 * ONE_MIB;
export const FIRST_TRUSTED_HYDRATION_RESERVE_BYTES = Math.floor(1.5 * ONE_MIB);
export const TOP_RESULTS_MAX_UNCACHED_BYTES = 10 * ONE_MIB;
export const TOP_RESULTS_HYDRATION_RESERVE_BYTES = Math.floor(2.25 * ONE_MIB);
export const MIN_FIRST_TRUSTED_LOCAL_INDEXES = 6;
export const MIN_TOP_RESULTS_LOCAL_INDEXES = 12;
