...
from academics.exam.records.model import ExamDataError, parse_exam_period
from academics.exam.records.identity import canonicalize_exam_records, class_file_key, compare_exam_records
from academics.exam.snapshot.model import ExamSnapshot
from academics.exam.history.build import build_exam_history
...
def test_mixed_exam_period_history_fails_fast():
    ...
    with pytest.raises(ExamDataError, match="one exam_period_id"):
