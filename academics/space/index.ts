...
const eligibility = (value: unknown, source: string): 'eligible'|'ineligible' => { if(value!=='eligible'&&value!=='ineligible') throw new SpaceContractError(`${source}: eligibility must be terminal`); return value; };
