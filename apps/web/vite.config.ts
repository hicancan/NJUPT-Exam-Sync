...
export default defineConfig(({ command }) => {
  ...
  resolve: {
    alias: {
      ...
      '@njupt-search/academics-timetable': path.resolve(__dirname, '../../academics/timetable/index.ts'),
      '@njupt-search/academics-space': path.resolve(__dirname, '../../academics/space/index.ts'),
