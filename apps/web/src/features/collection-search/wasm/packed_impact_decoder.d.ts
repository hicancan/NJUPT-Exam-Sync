...
export class PackedImpactRetrievalSession {
    free(): void;
    [Symbol.dispose](): void;
    apply_terms_utf8_stats_f64(bytes: Uint8Array, query_terms_utf8: Uint8Array, query_term_offsets: Uint32Array): Float64Array;
    constructor(target_candidates: number);
    score_entries_f64(): Float64Array;
    stats_f64(): Float64Array;
}
...
export interface InitOutput {
    ...
    readonly packedimpactretrievalsession_apply_terms_utf8_stats_f64: (a: number, b: number, c: number, d: number, e: number, f: number, g: number) => [number, number, number, number];
    ...
    readonly packedimpactretrievalsession_stats_f64: (a: number) => [number, number];
